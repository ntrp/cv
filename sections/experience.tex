...
%---------------------------------------------------------
  \cventry
    ...
    {Remote} % Location
    {Jun. 2025 - around May 2026} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Contributed in design the architecture of the new part management application handling around 20M parts}
        \item {Implemented and optimized the ingestion into postgresql via transactional outbox pattern and azure blob kafka connect source}
        \item {Implemented delivery to materialized part data to Elasticsearch via kafka connect sink}
        \item {Configured infrastructure deployment using CDKTF on Azure}
        \item {Contributed on frontend features in the React web application}
      \end{cvitems}
    }
