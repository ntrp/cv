...
%---------------------------------------------------------
  \cventry
    {Architect and Full Stack developer (Freelance)} % Job title
    {Carl Zeiss AG} % Organization
    {Remote} % Location
    {Jun. 2025 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Designed the architecture of the new part management application handling 20M+ parts}
        \item {Implemented and optimized the ingestion into postgresql from azure blob via kafka connect source}
        \item {Implemented delivery of materialized part data to Elasticsearch via kafka connect sink}
        \item {Configured infrastructure deployment using CDKTF on Azure and Confluent Cloud}
        \item {Configured fine grained permissions setup for Confluent Cloud topics and cluster via IaC}
        \item {Implemented portal public UI and management area parts in React}
        \item {Developed multi service architecture in Java handling part taxonomy and schema and part ingestion}
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {Technical Lead (Freelance)} % Job title
    {Porsche Digital GmbH} % Organization
    {Remote} % Location
    {Nov. 2023 - May 2025} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    {Solution Architect and Fullstack Developer (Freelance)} % Job title
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Internal trainings and public training offering for Kafka and Confluent}
        \item {Spoke in conferences about Kafka ALC management, Event Driven Architecture}
        \item {Design and creation of a low code PoC based on Kafka, Confluent ksqlDB and Next.js for a demo factory dashboard}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Facilitated MyPorsche cross team architectural discussions by providing valuable insights}
